...
namespace FiniteStateMachine.DomainModel
{
    public class StateMachine
    {
        ...
        public String RepresentSequence(FSMSequence sequence)
        {
            ...
            //list of vertices
            List<CustomVertex> listOfVertices = new List<CustomVertex>();
            ...
            try
            {
                ...
                try
                {
                    ...
                    listOfVertices.Add(new CustomVertex(newState));//adds  the node to the list of vertices
                    ...
                    for (int i = 1; i < sequence.ArrayOfStep.Count; i++)
                    {
                        ...
                        try
                        {
                            ...
                            try
                            {
                                ...
                                listOfVertices.Add(new CustomVertex(newState));
                                Graph.Graph.AddVertex(listOfVertices.Last());
                                Graph.Graph.AddEdge(new CustomEdge("1",listOfVertices.ElementAt(listOfVertices.Count - 2), listOfVertices.Last()));
