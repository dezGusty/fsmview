...
namespace FSMControl
{
    ...
    public class CustomVertex : INotifyPropertyChanged
    {
        ...
        /// Initializes a new instance of the <see cref="CustomVertex"/> class.
        /// </summary>
        public CustomVertex(string text, Color color, string highlight, double x, double y)
        {
            this.text = text;
            this.highlight = bool.Parse(highlight);
            this.positionX = x;
            this.positionY = y;
            this.color = color;
        }
        ...
        public CustomVertex(string text, Color color, bool display)
        {
            this.text = text;
            this.color = color;
            this.highlight = false;
